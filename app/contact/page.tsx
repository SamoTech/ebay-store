      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
            ...
            <form className="space-y-6" action="https://formspree.io/f/mpqjrzzy" method="POST">
              {/* Name */}
              <div>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Monday - Friday<br/>9:00 AM - 6:00 PM EET</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center hover:bg-blue-200 dark:hover:bg-blue-900/50 transition-colors">
