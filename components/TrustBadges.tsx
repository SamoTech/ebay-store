      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="font-semibold text-sm text-gray-800 dark:text-white">Buyer Protection</p>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="font-semibold text-sm text-gray-800 dark:text-white">Secure Shopping</p>
